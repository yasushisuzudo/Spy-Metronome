...
### if you live in the windows, place wav files in the same folder as this file, and
### comment out above two lines and uncomment below two lines.
...
if ENABLE_VOL == True:
    ...
    mainWindowSize = (260,350)
else:    
    mainWindowSize = (260,300)

borderValue = 10

INIT_PATTERN = [ON, OFF, OFF, OFF] # initial value for click pattern. OFF, ON or ACCENT.
